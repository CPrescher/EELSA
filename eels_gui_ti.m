...
hTabGroup = uitabgroup('v0','parent',rpanh1,'SelectionChangeFcn', @tabGroupCB);
...
tab1 = uitab('v0',hTabGroup, 'title','ZLAna');
...
tab2 = uitab('v0',hTabGroup, 'title','DatAna');
...
tab3=uitab('v0',hTabGroup, 'title','Fe edge');
...
tab4=uitab('v0',hTabGroup, 'title','General');
